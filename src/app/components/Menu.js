...
export default function Menu() {
  ...
  return (
    <header className="fixed w-full pt-2 font-bold">
      <nav className={activeButton === "about" ? "text-secundary flex justify-around cursor-pointer" : "text-primary flex justify-around cursor-pointer"}>
