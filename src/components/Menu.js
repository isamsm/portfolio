    ...
    return (
        <div className="text-copper font-philosopher lg:h-full h-fit lg:absolute lg:right-[60px] lg:p-0 pt-2 lg:w-[200px]">  
            <div className="flex lg:flex-col flex-wrap items-center lg:justify-center justify-between lg:text-4xl text-xl h-full lg:gap-2 lg:p-0 px-3">
                <button onClick={() => setActiveMenu("Home")} className="flex flex-col gap-1 items-center w-fit lg:w-[135px] lg:border border-transparent hover:border-caramel">
                ...
                <button onClick={() => setActiveMenu("About")} className="flex flex-col gap-1 items-center w-fit lg:w-[135px] lg:border border-transparent hover:border-caramel">
                ...
                <button onClick={() => setActiveMenu("Skills")} className="flex flex-col gap-1 items-center w-fit lg:w-[135px] lg:border border-transparent hover:border-caramel">
                ...
                <button onClick={() => setActiveMenu("Projects")} className="flex flex-col gap-1 items-center w-fit lg:w-[135px] lg:border border-transparent hover:border-caramel">
